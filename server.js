...
sever.listen(8095);
console.log('Sever is running at 192.168.16.195:8095/');
...
//     console.log(`url: http://192.168.16.195:${port}`);
//     cp.exec(`explorer http://192.168.16.195:${port}`, function () {
//     });
// });
...
//                         if (file === "login.html") {
//                             readFile(filePath + (filePath[filePath.length-1]=='/' ? '' : '/') + 'login.html', "text/html");
//                             flag = true;
//                             break;
//                         };
