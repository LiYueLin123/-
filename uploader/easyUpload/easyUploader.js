...
;(function(window, document) {
    ...
    var defaultConfigs = {
        id: "uploader", /* 渲染容器id */
        accept: '.jpg,.png,.doc,docx,.txt,.xls,.xlsx', /* 上传类型 */
        action: "http://192.168.16.198:8866/erp/Document/UploadDocument?uid=44&formId=6647&formKey=Purc_PurFormList", /* 上传地址 */
